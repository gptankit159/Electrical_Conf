...
<div class="wraph">
    ...
    <div class="container-fluid my-5 bannerImg">
        ...
        <div class="banner text-center">
            <h5>Department of Electrical Engineering Organizes</h5>
            <h6>An International Conference On</h6>
            <h3 class="text-uppercase "><strong>Intelligent Technologies for Sustainable Energy Management and Control 
                </strong></h3>
            <button class="btn btn_itsemc">
                <h3 class="margin-0"><strong style="text-shadow: none;">ITSEMC-2023</strong></h3>
            </button>
